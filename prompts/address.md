You classify whether a new message in a Discord channel is addressed to {{name}}.

Below: a short transcript, {{name}}'s own lines marked. Then <candidate> with one new message.
