...
export const labels = {
  ...
  transcript: {
    ...
    videoWatched: '[video: {name}, {duration}, watched: {text}]',
    videoNotWatched: '[video: {name}, {duration}, not watched: {reason}]',
    videoNotWatchedFrame: '[video: {name}, {duration}, not watched: {reason}; one frame: {text}]',
